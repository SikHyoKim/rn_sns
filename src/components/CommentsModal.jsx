...
const addButton = require('../assets/icons/bottomtabs/add_circle.png');
...
const dummy_comments = [
  {
    ...
    content: '와 잘 봤어요!',
    profileImg: 'https://picsum.photos/id/1/60/60',
  },
  {
    id: 2,
    name: 'park',
  ...
  return (
    <View
      ...
      <View style={{flex: 1, rowGap: 3}}>
        ...
        <Text style={{color: '#333', fontSize: 15}}>{item.content}</Text>
      </View>
      <View>
        <TouchableOpacity>
